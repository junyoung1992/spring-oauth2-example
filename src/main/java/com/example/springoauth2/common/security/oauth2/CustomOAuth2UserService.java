...
import com.example.springoauth2.common.security.oauth2.user.OAuth2UserInfo;
import com.example.springoauth2.common.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        User user = User.oauthRegisterBuilder()
